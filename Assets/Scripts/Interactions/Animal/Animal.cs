...
public class Animal : MonoBehaviour
{
    ...
    private void OnTriggerEnter2D(Collider2D collision)
    {
        ...
        {
            string sound = GetAnimalSound(animalType);
            DebugMessageUI.Instance.ShowMessage(sound);
            Debug.Log(sound);
        }
    }

    private string GetAnimalSound(string type)
    {
        switch (type.ToLower())
        {
            case "cow": return "MOO";
            ...
            default: return "Unknown animal sound!";
        }
    }
}
